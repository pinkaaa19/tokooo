...
class MotifController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // --- SOLUSI EROR: AUTOMATED KNOWLEDGE LINKING ---
        // PERBAIKAN: Mengubah target kolom dari 'motif_id' menjadi 'knowledge_id'
        \App\Models\Product::where('name', 'like', '%' . $request->title . '%')
                           ->whereNull('knowledge_id')
                           ->update(['knowledge_id' => $knowledge->id]);
        // ----------------------------------------------
    ...
    public function show(int $id)
    {
        ...
        // Memastikan keselarasan folder views admin
    ...
    public function update(Request $request, int $id)
    {
        ...
        // --- RELINKING SAAT UPDATE (OPSIONAL) ---
        // Memastikan jika judul berubah, produk dicocokkan ulang dengan aman
        \App\Models\Product::where('name', 'like', '%' . $request->title . '%')
                           ->whereNull('knowledge_id')
                           ->update(['knowledge_id' => $knowledge->id]);
    ...
    public function destroy(int $id)
    {
        ...
        // Kosongkan referensi relasi pada tabel produk sebelum motif dihapus agar tidak eror
        \App\Models\Product::where('knowledge_id', $id)->update(['knowledge_id' => null]);
